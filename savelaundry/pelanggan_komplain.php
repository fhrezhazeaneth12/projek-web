...
<head>
    ...
    <title>Pelanggan: Komplain</title>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="list-group mt-3">
                ...
                <a href="pelanggan_komplain.php" class="list-group-item list-group-item-action active">Komplain</a>
            </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card mb-3">
              <div class="card-header">
                Masukkan detil komplain
              </div>
              <div class="card-body">
              <form>
            <div class="form-group">
							<label for="exampleFormControlInput1">Jenis Komplain</label>
							<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Jenis Komplain">
						</div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Detil Komplain</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    ...
                    <div class="form-group">
                      <input type="submit" class="form-control btm btn-primary" id="exampleFormControlInput1" value="ajukan" >
                    </div>
                                      </form>
                                  </div>
