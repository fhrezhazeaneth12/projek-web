    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="list-group mt-3">
                ...
                <a href="admin_laporan.php" class="list-group-item list-group-item-action active">Laporan</a>
            </div>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-3">
                <div class="card-body">
                <h1>Laporan Manajemen Laundry</h1>
                </div>
            </div>

            <div class="card mb-3">
                <div class="card-body">
				<label for="exampleFormControlInput1"><b>Data Laundry Berjalan</b> </label>
			...
			<div class="card mb-3">
                <div class="card-body">
				<label for="exampleFormControlInput1"><b> Data Komplain Berjalan</b></label>
				<table class="table table-hover">
					<thead>
						<tr>
						<th scope="col">#</th>
